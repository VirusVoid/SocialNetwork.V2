...
public class UserController {
    ...
    public ResponseEntity<?> getFriendList(@PathVariable Integer id) {
        Set<Users> list = userService.getFriendList(id);
     ...
     */
    @PostMapping("friend")
    public void createFriend(@RequestBody @Valid FriendsRequestDto friends){
        userService.createFriendRequest(friends);
    }
}